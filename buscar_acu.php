...
<table width="100%">
    <tr>       
        ...
        <th><label for="busqueda">INGRESAR</label><br><a href="ingresar_acu.php" class="btn btn-info">INGRESAR ACUDIENTE</a></th>
            

        <th ><form  action="buscar_acu.php" method="get" ><br>
        ...
        <th></th>
             ...
             <table class="table" >
                                ...
                                <tbody>
                                        <?php
                                        $sql="SELECT id_acud,tipo_doc,nom_acu,ape_acu,parentesco,dir_acu,id_pais,id_ciu,tel_acu,id_est FROM acudiente WHERE ( id_acud = '$busqueda' OR 
                            nom_acu LIKE '%$busqueda%' OR
                            ape_acu LIKE '%$busqueda%' OR 
                            id_est LIKE '$busqueda' )";
    ...
    $query=mysqli_query($con,$sql);
                                        ...
                                        ?>
                                            <tr>
                                                <th><?php  echo $row['id_acud']?></th>
                                                <th><?php  echo $row['tipo_doc']?></th>
                                                <th><?php  echo $row['nom_acu']?></th>
                                                <th><?php  echo $row['ape_acu']?></th>
                                                <th><?php  echo $row['parentesco']?></th>
                                                <th><?php  echo $row['dir_acu']?></th>
                                                <th><?php  echo $row['id_pais']?></th>
                                                <th><?php  echo $row['id_ciu']?></th>
                                                <th><?php  echo $row['tel_acu']?></th>
                                                <th><?php  echo $row['id_est']?></th> 
                                                <th><a href="actualizar_acu.php?id_acud=<?php echo $row['id_acud'] ?>" class="btn btn-info">Editar</a></th>
                                                <th><a href="delete_acu.php?id_acud=<?php echo $row['id_acud'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                            </tr>
