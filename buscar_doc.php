...
<table width="100%">
    <tr>       
        ...
        <th><label for="busqueda">INGRESAR</label><br><a href="docentes.php" class="btn btn-info">INGRESAR DOCENTE</a></th>
            

        <th ><form  action="buscar_doc.php" method="get" ><br>
            <label for="busqueda">BUSCAR</label>
            <input  type="text" name="busqueda" id="busqueda" class="form-control mb-3" class="btn_search" placeholder="Id, Nombre, Apellido" value="<?php echo $busqueda; ?>" >
        ...
        <th></th>
             ...
             <table class="table"  style="font-size: 12px;" >
                                ...
                                <tbody>
 <?php
    $sql="SELECT id_doc, tipo_doc, nom_doc, ape_doc, gen_doc, dir_doc, ed_doc, tel_doc, em_doc, id_pais, id_ciu, id_area, id_asig FROM docentes WHERE ( id_doc = '$busqueda' OR 
                            nom_doc LIKE '%$busqueda%' OR
                            ape_doc LIKE '%$busqueda%' 
                             )";
    ...
    $query=mysqli_query($con,$sql);
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <th><a href="actualizar_doc.php?id_doc=<?php echo $row['id_doc'] ?>" class="btn btn-info">Editar</a></th>
                                                <th><a href="delete_doc.php?id_doc=<?php echo $row['id_doc'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                            </tr>
