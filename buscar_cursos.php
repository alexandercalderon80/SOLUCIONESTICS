...
<table width="100%">
    <tr>       
        ...
        <th ><form  action="buscar_cursos.php" method="get" ><br>
            ...
            <input  type="text" name="busqueda" id="busqueda" class="form-control mb-3" class="btn_search" placeholder="id, curso, id año academico, id doc" value="<?php echo $busqueda; ?>" >
        ...
        <th></th>
             ...
             <table class="table" >
                                ...
                                <tbody>
 <?php
    $sql="SELECT id_curso, nom_curso, id_ano_acad, id_doc FROM cursos WHERE ( id_curso = '$busqueda' OR 
                            nom_curso LIKE '%$busqueda%' OR
                            id_ano_acad LIKE '$busqueda' OR
                            id_doc LIKE '$busqueda' )";
