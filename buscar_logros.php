...
<table width="100%">
    <tr>       
        ...
        <th><label for="busqueda">INGRESAR</label><br><a href="ingresar_logros.php" class="btn btn-info">INGRESAR LOGROS</a></th>
            

        <th ><form  action="buscar_logros.php" method="get" ><br>
            <label for="busqueda">BUSCAR</label>
            <input  type="text" name="busqueda" id="busqueda" class="form-control mb-3" class="btn_search" placeholder="id o logro" value="<?php echo $busqueda; ?>" >
        ...
        <th></th>
             ...
             <table class="table" >
                                ...
                                <tbody>
 <?php
    $sql="SELECT id_logro, nom_logro, per_logro, id_ano_esc FROM logros WHERE ( id_logro = '$busqueda' OR 
                            nom_logro LIKE '%$busqueda%'  )";
    ...
    $query=mysqli_query($con,$sql);
                                        ...
                                        ?>
                                            <tr>
                                                <th><?php echo $row['id_logro']?></th>
                                                <th><?php echo $row['nom_logro']?></th>
                                                <th><?php echo $row['per_logro']?></th>
                                                <th><?php echo $row['id_ano_esc']?></th>


                                                <th><a href="actualizar_logros.php?id_logro=<?php echo $row['id_logro'] ?>" class="btn btn-info">Editar</a></th>
                                                <th><a href="delete_logros.php?id_logro=<?php echo $row['id_logro'] ?> " class="btn btn-danger">Eliminar</a></th> 
                                                 </tr>
