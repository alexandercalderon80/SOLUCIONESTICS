...
<table width="100%">
    <tr>       
        ...
        <th><label for="busqueda">INGRESAR</label><br><a href="ingresar_ciu.php" class="btn btn-info">INGRESAR CIUDAD</a></th>
            

        <th ><form  action="buscar_ciu.php" method="get" ><br>
        ...
        <th></th>
             ...
             <table class="table" >
                                ...
                                <tbody>
 <?php
    $sql="SELECT id_ciu, nom_ciu FROM ciudad WHERE ( id_ciu = '$busqueda' OR 
                            nom_ciu LIKE '%$busqueda%')";
    ...
    $query=mysqli_query($con,$sql);
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <th><?php echo $row['nom_ciu']?></th>
                                                <th><a href="actualizar_ciu.php?id_ciu=<?php echo $row['id_ciu'] ?>"class="btn btn-info">Editar</a></th>
                                                <th><a href="delete_ciu.php?id_ciu=<?php echo $row['id_ciu'] ?>" class="btn btn-danger">Eliminar</a></th>                        
                                            </tr>
