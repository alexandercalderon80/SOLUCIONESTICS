...
<table width="100%">
    <tr>       
        ...
        <th><label for="busqueda">INGRESAR</label><br><a href="ingresar_asignaturas.php" class="btn btn-info">INGRESAR ASIGNATURAS</a></th>


        <th ><form  action="buscar_asignaturas.php" method="get" ><br>
            <label for="busqueda">BUSCAR</label>
            <input  type="text" name="busqueda" id="busqueda" class="form-control mb-3" class="btn_search" placeholder="Id o Area ">
